...
syn keyword sqlKeyword primary key recursive references returning right
...
syn keyword sqlKeyword sequence key cascade type role schema add domain start index declare begin exception returns if elsif
...
syn keyword sqlStatement truncate update reset set raise return
...
syn keyword sqlFunc     rank dense_rank percent_rank cume_dist ntile lag
