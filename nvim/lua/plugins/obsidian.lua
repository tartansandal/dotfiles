return {
  ...
  opts = {
    ...
    -- telescope.nvim, fzf-lua, or fzf.vim (in that order), and use the first one they
    -- find. You can set this option to tell obsidian.nvim to always use this finder.
    ...
    ui = {
      ...
      checkboxes = {
        -- NOTE: the 'char' value has to be a single character, and the highlight groups
        -- are defined below.
      ...
      hl_groups = {
        -- The options are passed directly to `vim.api.nvim_set_hl()`. See `:help
        -- nvim_set_hl`.
