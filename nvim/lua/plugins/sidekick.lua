local function toggle_claude(layout)
  return function()
...
return {
  ...
  keys = {
    { "<leader>ac", toggle_claude("float"), desc = "Sidekick Toggle Claude (float)" },
    { "<leader>as", toggle_claude("right"), desc = "Sidekick Toggle Claude (split)" },
  },
}
